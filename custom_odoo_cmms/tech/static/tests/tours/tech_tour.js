...
tour.register('tech_appointments_hour_tour', {
    url: '/web',
    test: true,
}, [
    tour.stepUtils.showAppsMenuItem(),
    {
        trigger: '.o_app[data-menu-xmlid="tech.mail_menu_tech"]',
        content: 'Open Tech',
        run: 'click',
    },
    {
        trigger: '.o-tech-button-new',
    ...
    {
        trigger: '.dropdown-item:contains("Tech")',
        content: 'Go back to Tech view',
        run: 'click',
    },
    {
        trigger: '.dropdown-toggle:contains("Week")',
        content: 'Click to change tech view',
        run: 'click',
    },
    {
        trigger: '.dropdown-item:contains("Month")',
        content: 'Change the tech view to Month',
        run: 'click',
    },
    {
        trigger: '.fc-day-header:contains("Monday")',
        content: 'Change the tech view to week',
    },
    {
...
tour.register('test_tech_delete_tour', {
    test: true,
},
[
    {
...
tour.register('test_tech_decline_tour', {
    test: true,
},
[
    {
...
tour.register('test_tech_decline_with_everybody_filter_tour', {
    test: true,
},
[
    {

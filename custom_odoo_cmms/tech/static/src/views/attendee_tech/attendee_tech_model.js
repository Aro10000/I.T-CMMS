...
import { TechModel } from "@web/views/tech/tech_model";
import { askRecurrenceUpdatePolicy } from "@tech/views/ask_recurrence_update_policy_hook";
import { ConfirmationDialog } from "@web/core/confirmation_dialog/confirmation_dialog";

export class AttendeeTechModel extends TechModel {
    setup(params, { dialog }) {
        ...
        if (!isEveryoneFilterActive) {
            ...
            for (const event of Object.values(data.records)) {
                ...
                for (const attendee of attendees) {
                    ...
                    if (attendeeInfo) {
                        ...
                        record.techAttendeeId = attendeeInfo.attendee_id;
                    }
            ...
            for (const event of Object.values(data.records)) {
                ...
                if (attendeeInfo) {
                    ...
                    event.techAttendeeId = attendeeInfo.attendee_id;
                }
            }
        }
    }
...
AttendeeTechModel.services = [...TechModel.services, "dialog", "orm"];

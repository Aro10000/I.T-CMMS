...
class Contacts(models.Model):
    ...
    partner_checked = fields.Boolean('Checked', default=True)  # used to know if the partner is checked in the filter of the tech view for the user_id.

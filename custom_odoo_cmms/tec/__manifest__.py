...

{
    'name': 'Tec',
    'version': '1.3',
    'website': 'https://www.odoo.com/app/tec',
    'category': 'Services/Tec',
    'sequence': 15,
    'summary': 'Organize and plan your tecs',
    'depends': [
        'analytic',
        'base_setup',
        'mail',
    ...
    'data': [
        'security/tec_security.xml',
        'security/ir.model.access.csv',
        'security/ir.model.access.xml',
        'data/digest_data.xml',
        'report/tec_report_views.xml',
        'report/tec_task_burndown_chart_report_views.xml',
        'views/analytic_views.xml',
        'views/digest_views.xml',
        'views/rating_rating_views.xml',
        'views/tec_update_views.xml',
        'views/tec_update_templates.xml',
        'views/tec_tec_stage_views.xml',
        'wizard/tec_share_wizard_views.xml',
        'views/tec_collaborator_views.xml',
        'views/tec_views.xml',
        'views/tec_milestone_views.xml',
        'views/res_partner_views.xml',
        'views/res_config_settings_views.xml',
        'views/mail_activity_views.xml',
        'views/tec_sharing_views.xml',
        'views/tec_portal_templates.xml',
        'views/tec_task_templates.xml',
        'views/tec_sharing_templates.xml',
        'data/ir_cron_data.xml',
        'data/mail_message_subtype_data.xml',
        'data/mail_template_data.xml',
        'data/tec_data.xml',
        'wizard/tec_task_type_delete_views.xml',
    ],
    'demo': [
    ...
    'installable': True,
    'application': True,
    'post_init_hook': '_tec_post_init',
    'assets': {
        'web.assets_backend': [
            'tec/static/src/css/tec.css',
            'tec/static/src/utils/**/*',
            'tec/static/src/services/**/*',
            'tec/static/src/components/**/*',
            'tec/static/src/views/**/*',
            'tec/static/src/js/tec_activity.js',
            'tec/static/src/js/tec_control_panel.js',
            'tec/static/src/js/tec_graph_view.js',
            'tec/static/src/js/tec_pivot_view.js',
            'tec/static/src/js/tec_rating_graph_view.js',
            'tec/static/src/js/tec_rating_pivot_view.js',
            'tec/static/src/js/tec_task_kanban_examples.js',
            'tec/static/src/js/tours/tec.js',
            'tec/static/src/js/widgets/*',
            'tec/static/src/scss/tec_dashboard.scss',
            'tec/static/src/scss/tec_form.scss',
            'tec/static/src/scss/tec_widgets.scss',
            'tec/static/src/xml/**/*',
        ],
        'web.assets_frontend': [
            'tec/static/src/scss/portal_rating.scss',
            'tec/static/src/scss/tec_sharing_frontend.scss',
            'tec/static/src/js/portal_rating.js',
        ],
        'web.qunit_suite_tests': [
            'tec/static/src/tec_sharing/components/portal_file_input/portal_file_input.js',
            'tec/static/tests/**/*.js',
        ],
        'web.assets_tests': [
            'tec/static/tests/tours/**/*',
        ],
        'tec.webclient': [
            ...
            'tec/static/src/components/tec_task_name_with_subtask_count_char_field/*',
            'tec/static/src/views/tec_task_form/*.scss',

            'tec/static/src/tec_sharing/search/favorite_menu/custom_favorite_item.xml',
            'tec/static/src/tec_sharing/**/*',

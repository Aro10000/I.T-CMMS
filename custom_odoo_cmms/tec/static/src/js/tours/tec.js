odoo.define('tec.tour', function(require) {
"use strict";
...
tour.register('tec_tour', {
    sequence: 110,
    url: "/web",
    rainbowManMessage: _t("Congratulations, you are now a master of tec management."),
}, [tour.stepUtils.showAppsMenuItem(), {
    trigger: '.o_app[data-menu-xmlid="tec.menu_main_pm"]',
    content: Markup(_t('Want a better way to <b>manage your tecs</b>? <i>It starts here.</i>')),
    position: 'right',
    edition: 'community',
}, {
    trigger: '.o_app[data-menu-xmlid="tec.menu_main_pm"]',
    ...
    content: Markup(_t('Let\'s create your first <b>tec</b>.')),
    position: 'bottom',
    width: 200,
}, {
    trigger: '.o_tec_name input',
    content: Markup(_t('Choose a <b>name</b> for your tec. <i>It can be anything you want: the name of a customer,\
    ...
    trigger: ".o_kanban_tec_tasks .o_column_quick_create .input-group .o_input",
    ...
    extra_trigger: '.o_form_tec_tasks',
    ...
    extra_trigger: '.o_form_tec_tasks.o_form_dirty',

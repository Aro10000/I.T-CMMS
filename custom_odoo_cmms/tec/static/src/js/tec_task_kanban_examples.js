...
const exampleData = {
    ...
    applyExamplesText: _lt("Use This For My Tec"),
    ...
    examples:[{
        ...
        get description() {
            return renderToMarkup("tec.example.generic");
        },
        ...
        get description() {
            return renderToMarkup("tec.example.agilescrum");
        },
        ...
        get description() {
            return renderToMarkup("tec.example.digitalmarketing");
        },
        bullets: [greenBullet, redBullet],
    }, {
        ...
        get description() {
            return renderToMarkup("tec.example.customerfeedback");
        },
        bullets: [greenBullet, redBullet],
    }, {
        name: _lt('Consulting'),
        columns: [_lt('New Tecs'), _lt('Resources Allocation'), _lt('In Progress'), _lt('Done')],
        get description() {
            return renderToMarkup("tec.example.consulting");
        },
        bullets: [greenBullet, redBullet],
    }, {
        name: _lt('Research Tec'),
        columns: [_lt('Brainstorm'), _lt('Research'), _lt('Draft'), _lt('Final Document')],
        get description() {
            return renderToMarkup("tec.example.researchtec");
        },
        bullets: [greenBullet, redBullet],
    }, {
        ...
        get description() {
            return renderToMarkup("tec.example.tshirtprinting");
        },
        bullets: [star],
    }, {
        name: _lt('Design'),
...
kanbanExamplesRegistry.add('tec', exampleData);
registry.category("kanban_examples").add('tec', exampleData);

...
export class TecSharingWebClient extends Component {
    setup() {
    ...
    async _showView() {
        const { action_name, tec_id, open_task_action } = session;
...
TecSharingWebClient.components = { ActionContainer, MainComponentsContainer };
TecSharingWebClient.template = 'tec.TecSharingWebClient';

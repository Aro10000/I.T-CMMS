...
import { getFirstElementForXpath } from './tec_test_utils';
                ...
                models: {
                    burndown_chart: {
                        fields: {
                            ...
                            tec_id: { string: "Tec", type: "many2one", relation: "tec", store: true, sortable: true },
                        ...
                        records: [
                            { id: 1, tec_id: 1, stage_id: 1, date: "2020-01-01", nb_tasks: 10 },
                            { id: 2, tec_id: 1, stage_id: 2, date: "2020-02-01", nb_tasks: 5 },
                            { id: 3, tec_id: 1, stage_id: 3, date: "2020-03-01", nb_tasks: 2 },
                        ],
                    },
                    tec: {
                        fields: {
                            name: { string: "Tec Name", type: "char" },
                        },
                        records: [{ id: 1, name: "Tec A" }]
                    },
                    stage: {
                        fields: {

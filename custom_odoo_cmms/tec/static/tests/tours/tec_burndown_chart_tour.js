...
[tour.stepUtils.showAppsMenuItem(), {
    ...
    content: 'Open "Burndown Chart Test" tec menu',
    trigger: '.o_kanban_record:contains("Burndown Chart Test") .o_kanban_manage_toggle_button',
}, {
    content: `Open "Burndown Chart Test" tec's "Burndown Chart" view`,
    ...
    content: 'Remove the tec search "Burndown Chart Test"',
    ...
    trigger: '.o_searchview_autocomplete .o_menu_item:contains("Tec")',
}, {

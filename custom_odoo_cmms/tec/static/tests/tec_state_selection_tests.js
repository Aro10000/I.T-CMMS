...
QUnit.module("Tec", (hooks) => {
            ...
            arch: `
                <kanban  class="o_kanban_test">
                    ...
                    <template>
                        <t t-name="kanban-box">
                            <div>
                                <field name="last_update_status" widget="tec_state_selection" options="{'color_field': 'last_update_color'}"/>
                            </div>
                        </t>
                    </template>
                </kanban>`,
        ...
        QUnit.module("Components", (hooks) => {
            QUnit.module("TecStateSelectionField");
            QUnit.test("Check that TecStateSelectionField does not propose `Set Status`", async function (assert) {

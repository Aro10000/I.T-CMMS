...
class TecShareWizard(models.TransientModel):
    _name = 'tec.share.wizard'
    _inherit = 'portal.share'
    _description = 'Tec Sharing'
    ...
    def _selection_target_model(self):
        tec_model = self.env['ir.model']._get('tec.tec')
        return [(tec_model.model, tec_model.name)]
    ...
    def _compute_resource_ref(self):
        for wizard in self:
            if wizard.res_model and wizard.res_model == 'tec.tec':

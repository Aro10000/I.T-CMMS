...
/**
 * Compiler the portal chatter in tec sharing.
 *
...
function compileChatter(node, params) {
    ...
    setAttributes(chatterContainerXml, {
        ...
        resId: params.resId,
        tecSharingId: params.tecSharingId,
    });
...
export class TecSharingChatterCompiler extends ViewCompiler {
    setup() {
    ...
    compileChatter(node) {
        return compileChatter(node, {
            ...
            tecSharingId: 'model.root.context.active_id_chatter',
        });
    }
}
...
registry.category("form_compilers").add("portal_chatter_compiler", {
    ...
    fn: (node) =>
        compileChatter(node, {
            ...
            tecSharingId: "props.record.context.active_id_chatter",
        }),
});

patch(FormCompiler.prototype, 'tec_sharing_chatter', {
    compile(node, params) {

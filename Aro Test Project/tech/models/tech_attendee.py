...
class Attendee(models.Model):
    """ Tech Attendee Information """
    _name = 'tech.attendee'
    _rec_name = 'common_name'
    _description = 'Tech Attendee Information'
    ...
    def copy(self, default=None):
        raise UserError(_('You cannot duplicate a tech attendee.'))
    ...
    def _send_mail_to_attendees(self, mail_template, force_send=False):
        ...
        if self.env['ir.config_parameter'].sudo().get_param('tech.block_mail') or self._context.get("no_mail_to_attendees"):
            return False
